...
const int irSensor = 2;  // sensörün bağlı olduğu pin
int led = 4;
...
void requestEvent() {
  ...
  Wire.write((byte*)&konum, sizeof(konum));
  Wire.write((byte*)&v_ort, sizeof(v_ort));
  Wire.write((byte*)&v_anlik, sizeof(v_anlik));
}